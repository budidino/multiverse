...
import hashlib # hash strings (detect league.html file changes)
...
def updateHighScores():
    ...
    with open(f'{oneDriveDir}githubProject/league.html', "r") as htmlFile:
    ...
    # update league.html file
    if hashStringNew != hashStringOld:
        print("updating league.html and pushing code")
        f = open(f'{oneDriveDir}githubProject/league.html', 'w')
        f.write(message)
        f.close()
